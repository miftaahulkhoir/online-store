<?php
    ...
    if ($button == 'Add') {
        ...
        mysqli_query($koneksi, "UPDATE barang SET nama_barang = '$nama_barang', spesifikasi = '$spesifikasi', $upload_gambar, harga = '$harga', stok ='$stok', status = '$status_barang' WHERE barang_id = '$barang_id'");
    }
